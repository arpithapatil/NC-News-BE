...
//   return Articles.findById({_id:req.params.article_id})
//     .then(article => {
//       console.log(article);
...
//     });
// };
// module.exports = {getAllTopics, getArticlesByTopic,getAllArticles,getArticlesByArticleId,getCommentsByArticleId,postCommentsByArticleId,voteArticleByArticleId,voteCommentByCommentId,deleteCommentByCommentId,getProfileDataByUsername};
